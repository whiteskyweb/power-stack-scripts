...
build_image () {
  ...
  printf "${GREEN_BG}Building ${2} image${NC}\n"
    ...
    docker build -t $CI_REGISTRY/$CI_PROJECT_PATH_SLUG/$CI_PROJECT_NAME/$1/$2:dev  -f ./infrastructure/docker/$1-$2/Dockerfile .
    docker login -u gitlab-ci-token -p $CI_JOB_TOKEN $CI_REGISTRY
    docker push $CI_REGISTRY/$CI_PROJECT_PATH_SLUG/$CI_PROJECT_NAME/$1/$2:dev
